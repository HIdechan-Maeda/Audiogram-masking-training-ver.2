...
- 原稿: `manuscripts/manuscript_IgakuKensa_AudioScopeEDU_technical_validity_JAMT_v2.34.docx`
- 表: `manuscripts/Tables1-3.docx`
- 付録md/json: `manuscripts/appendix_IgakuKensa_verification_results.{md,json}`
- Supplement: `manuscripts/Supplement1_verification_v2.34.docx`
...
- [x] 図3キャプションから a–h／パターン列挙を削除（代表例の視覚提示に限定）
